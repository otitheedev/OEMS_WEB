    ...
    <div class="grid grid-cols-1 md:grid-cols-1">
        ...
        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
            <div class=" ">
                ...
                <a href="{{ url('all_attendance') }}" class="btn btn-success" style="float:right">
                    Reload
                </a>
            </div>
            <div class="flex items-center">
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">All data from device : <b>Attendance</a></div>
            </div>
            <hr/>
