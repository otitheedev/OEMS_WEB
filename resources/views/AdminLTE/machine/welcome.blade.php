@extends('AdminLTE.machine.layout.layout')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="flex items-center">
            ...
            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                    <img src="{{ asset('assets/OG.png') }}" style="width: 75%;"/>
                </div>
                <br/>
        ...
        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">Test device : Testing IP({{ $deviceip }})</div>
            </div>
            ...
            <div class="ml-12">
                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                    ...
                    <a href="{{ route('myattendancerecoard.home') }}" class="btn btn-success btn-sm" style="margin: 5px">My Attendance Recoard</a>
