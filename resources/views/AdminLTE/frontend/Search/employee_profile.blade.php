...
@endif
                           ...
                           <a href="{{ $user->linkedin_link }}" class="fa fa-linkedin-square fa-3x"></a>
                                ...
                                <div class="list-group list-group-flush text-center mt-4">
                                    ...
                                    <h4><hr> QR Code </h4>
                            <img src="https://chart.googleapis.com/chart?chs=400x400&cht=qr&chl={{ url('/employee/ID/'). '/' .$user->phone_number }}" class="img-responsive" style="border:1px solid lightgrey">
                                </div>
