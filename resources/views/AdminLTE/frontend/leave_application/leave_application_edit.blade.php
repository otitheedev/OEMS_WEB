...
<form action="{{ url('/admin/application/update') }}" method="POST" enctype="multipart/form-data">
 ...
 <div class="row mt-1 mb-2">
  <div class="col-sm-6">
   ...
   <input type="date" class="form-control" name="application_start_date" value="{{ substr($leave->application_start_date, 0, 10) }}" required>
 </div>

 <div class="col-sm-6">
 <label for="end_date"><i class="fa-regular fa-user"></i> End Date <span class="text-danger">*</span></label>
   <input type="date" class="form-control" name="application_end_date" value="{{ substr($leave->application_end_date, 0, 10) }}" required>
 </div>
 </div>
