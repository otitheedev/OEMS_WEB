  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">All Appliations</h1>
          </div>
...
<!-- Your DataTable HTML -->
<table id="example" class="table display" style="max-width:100%; text-align:center;">
    <thead>
        <tr>
            <th>Employee </th>
            <th>Leave Type</th>
   ...
   <td>
   <span class="badge badge-info" style="font-size:16px;">{{ isset($applicate->application_start_date) ? $applicate->application_start_date->format('d M, Y l') : '--' }}</span> 
  </td> 

 <td> 
   <span class="badge badge-info" style="font-size:16px;"> {{ isset($applicate->application_end_date) ? $applicate->application_end_date->format('d M, Y l') : '--' }} </span>
    @php
