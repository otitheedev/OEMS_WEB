...
<div id="preview-container">
    <img id="image-preview" alt="Image Preview" src="{{ $user_data->profile_pic ? url('assets/users/' . $user_data->profile_pic) : url('http://via.placeholder.com/300x350') }}" onclick="openFileInput()">
...
<div class="container" style="background: #fffdfa;padding: 15px;border-radius: 15px;border: 1px solid lightgray;">
     ...
     <div class="col-sm-12 form-group">
        ...
        <input type="number" class="form-control" name="attendance_uid" placeholder="attendance_uid" value="{{ $user_data->attendance_uid }}" required>
      </div>
    
      <div class="col-sm-6 form-group">
        <label for="name-f"><i class="fa-regular fa-user"></i> Name <span class="text-danger">*</span></label>
        <input type="text" class="form-control" name="name" placeholder="Enter Name" value="{{ $user_data->name }}" required>
      </div>
      <div class="col-sm-6 form-group">
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="text" class="form-control" name="designation" id="designation" placeholder="Designation" value="{{ $user_data->designation }}" required>
      </div>
      <div class="col-sm-6 form-group">
        <label for="address"><i class="fa-regular fa-address-book"></i> Address <span class="text-danger">*</span></label>
        <input type="text" class="form-control" name="address" id="address" placeholder="Address" value="{{ $user_data->address }}" required>
      </div>
...
<!-- Department -->
      ...
      <div class="col-sm-6 form-group">
        ...
        <select class="form-control custom-select browser-default" name="department_name">
          <option selected> {{ $user_data->department_name }} </option>
  ...
  <div class="col-sm-3 form-group">
        ...
        <input type="Date" name="otithee_joining_date" class="form-control" value="{{ $user_data->otithee_joining_date }}" required>
      </div>
  ...
  <select class="form-control" name="blood_group" id="blood_group"> 
      ...
      <div class="col-sm-6 form-group">
        ...
        <select class="form-control custom-select browser-default" name="nationality_country">
          <option value="{{ $user_data->nationality_country }}" selected> {{ $user_data->nationality_country }}</option>
...
@foreach ($otherbyPercentage as $percentages) 
<div class="row col-sm-12 form-group mt-1">
<div class="col-sm-6 form-group">
    <label for="Date"><i class="fa-solid fa-home"></i> Other Benifits Name </label>
    <input type="text" name="other_benifits_name[]" class="form-control" id="text" value="{{ $percentages->other_benifits_name }}" placeholder="Benifits Name">
    </div>

    <div class="col-sm-6 form-group">
    <label for="Date"><i class="fa-solid fa-heart-circle-plus"></i> Other Benifits <i class="fa-solid fa-percent"></i></label>
    <input type="number" name="other_benifits_by_percentage[]" value="{{ $percentages->other_benifits_by_percentage }}" class="form-control" id="text" placeholder="Benifits %" onchange="calculateTotalAmount()">
    </div>
    </div>
@endforeach
<div class="col-sm-12 form-group">
<div id="dynamic-form-fields_percentage">
...
<div class="row col-12 mt-3" style="background: rgb(255, 253, 250); border: 1px solid lightgray; border-radius: 15px; padding: 15px;">
    <div class="col-12"> <h5><i class="fa fa-plus-circle" aria-hidden="true"></i> Payment Information</h5><hr></div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="number" name="bank_account_number_official" class="form-control" placeholder="Bank Account Number" value="{{ $user_data->bank_account_number_official }}">
      </div>

      <div class="col-sm-6 form-group">
        <label for="bank"><i class="fa-solid fa-money-check"></i> bKash Number</label>
        <input type="number" name="bkash_account_number" class="form-control" placeholder="bKash Number" value="{{ $user_data->bkash_account_number }}">
      </div>

      <div class="col-sm-6 form-group">
        <label for="bank"><i class="fa-solid fa-money-check"></i> Nogod Number</label>
        <input type="number" name="nogod_account_number" class="form-control" placeholder="Nogod Number" value="{{ $user_data->nogod_account_number }}">
      </div>

      <div class="col-sm-6 form-group">
        <label for="bank"><i class="fa-solid fa-mobile"></i> Rocket Number</label>
        <input type="number" name="rocket_account_number" class="form-control" placeholder="Rocket Number" value="{{ $user_data->rocket_account_number }}">
      </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
     ...
     <div class="col-12"> <h4><i class="fa-solid fa-circle-info"></i> Other Information</h4><hr></div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="number" name="nid_Information" class="form-control" id="nid_Information" placeholder="NID Number (Must Be matched with Candidate Age)" value="{{ $user_data->nid_Information }}" required>
      </div>
 

      <div class="col-sm-6 form-group">
        <label for="Date"><i class="fa-solid fa-language"></i> Language</label>
        <input type="text" name="language" class="form-control" value="{{ $user_data->language }}" placeholder="Language" required>
      </div>
      ...
      <div class="col-sm-2 form-group">
        ...
        <select class="form-control browser-default custom-select" name="phoneCountry" >
          <option>{{ $user_data->phoneCountry }}</option>
      ...
      <div class="col-sm-4 form-group">
        ...
        <input type="number" name="phone_number" class="form-control" id="tel" placeholder="Enter Your Contact Number." value="{{ $user_data->phone_number }}" required>
      </div>
      ...
      <div class="col-sm-3 form-group">
        ...
        <select id="sex" name="gender" class="form-control browser-default custom-select">
          <option value="{{ $user_data->gender }}" selected>{{ $user_data->gender }}</option>
...
<div class="col-sm-3 form-group">
  ...
  <select id="maritalStatus" name="marital_status" class="form-control browser-default custom-select">
    <option value="{{ $user_data->marital_status }}" selected> {{ $user_data->marital_status }} </option>
...
<div class="container" id="newUserForm" style="display: none;">
  ...
  <input type="text" name="spouse_name" class="form-control" value="{{ $user_data->spouse_name }}" placeholder="Spouse Name">
  </div>


  <div class="col-sm-6 form-group">
  <label><i class="fa-solid fa-cake-candles"></i> Spouse Birthday</label>
  <input type="date" name="spouse_birthday" value="{{ $user_data->spouse_birthday }}" class="form-control">
  </div>

  <div class="col-sm-6 form-group">
  <label> <i class="fa-solid fa-id-card"></i> Spouse NID</label>
  <input type="text" name="spouse_nid" value="{{ $user_data->spouse_nid }}" class="form-control" placeholder="Spouse NID Number">
  </div>


  <div class="col-sm-6 form-group">
  <label><i class="fa-solid fa-cake-candles"></i> Anniversary</label>
  <input type="date" name="spouse_anniversary" value="{{ $user_data->spouse_anniversary }}" class="form-control">
  </div>
      ...
      <!-- Academic Qualifications 1 (static) -->
        <div class="row col-12 mt-1" style="border: 1px solid lightgray;padding: 5px;border-radius:7px;">
            ...
            <div class="col-sm-3 form-group">
                ...
                <input type="text" class="form-control" name="degree_information[]" placeholder="Education Level 1" value="{{ $acp->degree_information }}">
            </div>

            <div class="col-sm-3 form-group">
                <label for="joiningYear">Joining Year {{ $acp->joining_year }}</label>
                <input type="date" name="joining_year[]" class="form-control" value="{{ $acp->join_year }}">
            </div>

            <div class="col-sm-3 form-group">
                <label for="passingYear">Passing Year</label>
                <input type="date" name="passing_year[]" class="form-control" value="{{ $acp->pass_year }}">
            </div>
        </div>
        @endforeach
...
<script>
    ...
    <div class="col-sm-12 form-group">
    <input type="text" name="father_name" class="form-control" placeholder="Father Name"  value="{{ $user_data->father_name }}"  required>
  </div>


  <label for="Date">Father Birthday</label>
      <div class="col-sm-12 form-group">
        <input type="date" name="father_birthday" value="{{ $user_data->birthday }}"  class="form-control">
      </div>
    ...
    <select name="father_occupation" class="form-control">
        ...
        @if(!$user_data->father_occupation)<option selected disabled>Select One </option> @endif
        <option @if($user_data->father_occupation) selected @endif>{{ $user_data->father_occupation }}</option> 
      ...
      <div class="col-sm-12 form-group">
        <input type="text" name="mother_name"  value="{{ $user_data->mother_name }}" class="form-control" placeholder="Mother Name" value="My Mother name" required>
      </div>
       
        <label for="Date">Mother Birthday</label>
      <div class="col-sm-12 form-group">
        <input type="date" name="mother_birthday" value="{{ $user_data->mother_birthday }}"  class="form-control">
      </div>
       
        <div class="col-sm-12 form-group">
        <label for="mother_occupation">Mother's Occupation</label>
        <select name="mother_occupation" class="form-control">
        <option selected>{{ $user_data->mother_occupation }}</option>
      ...
      <div class="col-sm-4 form-group">
        ...
        <input type="text" name="emergency_contact_name_1" class="form-control" value="{{ $user_data->emergency_contact_name_1 }}" placeholder="Emergency Contact Name" required>
      </div>
      ...
      <div class="col-sm-4 form-group">
        ...
        <input type="text" name="emergency_contact_name_2" class="form-control" value="{{ $user_data->emergency_contact_name_2 }}" placeholder="Emergency Contact Name" required>
      </div>
      ...
      <div class="col-sm-4 form-group">
        ...
        <input type="text" name="emergency_contact_relationship_2" class="form-control" value="{{ $user_data->emergency_contact_relationship_2 }}" placeholder="Emergency Contact Name" required>
      </div>
      </div><hr>
      </div>
      ...
      <div class="row col-12"><h4><i class="fa-regular fa-file"></i> Upload Resume <span class="text-danger">*</span></h4><hr></div>
        <input type="file" accept=".doc, .docx, .pdf" name="curriculum_vita_cv" class="form-control">
   <a href="{{ $user_data->curriculum_vita_cv ? url('assets/users/UserCV/' . $user_data->curriculum_vita_cv) : url('assets/OG.png') }}" target="_blank">{{ $user_data->curriculum_vita_cv }}</a>
   ...
   <!-- start loop -->
   @foreach ($UsersChildInfo as $uch)
  <div class="row">
    <div class="col-4 form-group">
      <label for="pass">Child Name {{ $uch->id }}</label>
      <input type="text" name="child_name[]" class="form-control" value="{{ $uch->child_name }}" placeholder="Child Name">
    </div>

    <div class="col-4 form-group">
      <label for="pass2">Gender</label>
      <select class="form-control custom-select browser-default" name="child_gender[]" >
          <option selected>{{ $uch->child_gender }}</option>
          <option>Male</option>
    ...
    <div class="col-4 form-group">
      ...
      <input type="date" name="child_birthday[]" value="{{ $uch->child_birthday }}" class="form-control">
    </div>
  </div>
  @endforeach
...
<script>
  ...
  function removeFormFields(button) {
    ...
    @foreach ($UsersProfessionalCertificate as $pro)
    <div class="row">
    <div class="col-sm-3 form-group">
      <label for="certName">Certificate Name {{ $pro->id }}</label>
      <input type="text" name="cert_name[]" class="form-control" value="{{ $pro->certificate_name }}" placeholder="Certificate Name">
    </div>

    <div class="col-sm-3 form-group">
      <label for="certName">Organization Name</label>
      <input type="text" name="cert_org_name[]" class="form-control" value="{{ $pro->organization_name }}" placeholder="Organization Name">
    </div>


    <div class="col-sm-3 form-group">
      <label for="certDate">Start Date</label>
      <input type="date" name="cert_start_date[]" value="{{ $pro->start_date }}" class="form-control">
    </div>

    <div class="col-sm-3 form-group">
      <label for="certDate">End Date</label>
      <input type="date" name="cert_end_date[]" value="{{ $pro->end_date }}" class="form-control">
    </div>
  </div> 
  @endforeach
  ...
  <button type="button" class="btn btn-primary mt-2" onclick="addCertificateFields()">Add More Certificates</button>
    ...
    <div class="container mt-2" style="background: #fffdfa;padding: 15px;border-radius: 15px;border: 1px solid lightgray;">
     ...
     @foreach ($JobExpriences as $job)
       <div class="row">
    <div class="col-sm-3 form-group">
      <label for="certName">Designation {{ $job->id }}</label>
      <input type="text" name="job_designation_name[]" value="{{ $job->job_designation_name }}" class="form-control" placeholder="Designation Name">
    </div>

    <div class="col-sm-3 form-group">
      <label for="certName">Organization Name</label>
      <input type="text" name="job_org_name[]" value="{{ $job->job_org_name }}" class="form-control" placeholder="Organization Name">
    </div>


    <div class="col-sm-3 form-group">
      <label for="certDate">Start Date</label>
      <input type="date" name="job_start_date[]" value="{{ $job->job_start_date }}" class="form-control">
    </div>

    <div class="col-sm-3 form-group">
      <label for="certDate">End Date</label>
      <input type="date" name="job_end_date[]" value="{{ $job->job_end_date }}" class="form-control">
    </div>
  </div> 
  @endforeach
...
<textarea class="form-control" name="medical_history_others" placeholder="Other History All Details Input Here">{{ $user_data->medical_history_others }}</textarea>
  ...
  @endforeach
   ...
   @endphp
    ...
    <textarea class="form-control" name="hobbies_and_interest" placeholder="Other Hobbies and interests" value="{{ $user_data->hobbies_and_interest }}">{{ $user_data->hobbies_and_interest }}</textarea>
...
<div class="container mt-2" style="background: #fffdfa;padding: 15px;border-radius: 15px;border: 1px solid lightgray;">
  ...
  <label for="facebook_link" class="mt-1"><i class="fa-brands fa-facebook"></i> Facebook Link</label><input type="text" name="facebook_link" class="form-control" placeholder="Facebook Link" value="{{ $user_data->facebook_link }}">

  <label for="twitter_link" class="mt-2"><i class="fa-brands fa-twitter"></i> Twitter Link</label><input type="text" name="twitter_link" class="form-control" placeholder="Twitter Link" value="{{ $user_data->twitter_link }}">

  <label for="instagram_link" class="mt-2"><i class="fa-brands fa-instagram"></i> Instagram Link</label><input type="text" name="instagram_link" class="form-control" placeholder="Instagram Link" value="{{ $user_data->instagram_link }}">

  <label for="linkedin_link" class="mt-2"><i class="fa-brands fa-linkedin"></i> Linkedin Link</label><input type="text" name="linkedin_link" class="form-control" placeholder="Linkedin Link" value="{{ $user_data->linkedin_link }}">

  <label for="tiktok_link" class="mt-2"><i class="fa-brands fa-tiktok"></i> Tiktok Link</label><input type="text" name="tiktok_link" class="form-control" placeholder="Tiktok Link" value="{{ $user_data->tiktok_link }}">

  <label for="youtube_link" class="mt-2"><i class="fa-brands fa-youtube"></i> YouTube Link</label><input type="text" name="youtube_link" class="form-control" placeholder="YouTube Link" value="{{ $user_data->youtube_link }}">
</div></div>
</div>
