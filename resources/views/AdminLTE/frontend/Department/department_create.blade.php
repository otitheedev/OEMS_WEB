...
<form action="{{ url('/admin/department/store') }}" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="file" class="form-control" id="formGroupPhoto" name="department_photo" required>
</div<>
...
<label for="formGroupExampleInput3">Details</label>
	<textarea name="department_information" id="div_editor1"></textarea>
</div>

		<script>
			var editor1 = new RichTextEditor("#div_editor1");

	       editor1.setHTMLCode("<p><b>Write Text here</b></p>");
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="formGroupExampleInput2" name="department_gm" placeholder="General Manager Name">
  </div>

<div class="form-group">
    <label for="formGroupExampleInput2">General Director</label>
    <input type="text" class="form-control" id="formGroupExampleInput2" name="department_director" placeholder="General Director Name">
</div>
